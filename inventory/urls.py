...
urlpatterns = [
    ...
    path('billing-working/', views.billing_working, name='billing_working'),
    path('billing-test/', views.billing_test, name='billing_test'),
    path('csv-billing/', views.csv_billing, name='csv_billing'),
    path('load-complete-csv/', views.load_complete_csv, name='load_complete_csv'),
    path('process-csv-shop-owner-order/', views.process_csv_shop_owner_order, name='process_csv_shop_owner_order'),
    path('process-complete-csv-order/', views.process_complete_csv_order, name='process_complete_csv_order'),
    path('manage-shop-owners/', views.manage_shop_owners, name='manage_shop_owners'),
